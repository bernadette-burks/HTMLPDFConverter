...
# Loading bar simulation for installation process
for i in tqdm(range(100), desc="Checking installation", unit="%"):
...
if converter:
    print(f"PDF successfully created at: {output_file}") # Feedback if conversion is successful
